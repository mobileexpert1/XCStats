...
public class EmailCoach_Adapter extends RecyclerView.Adapter<EmailCoach_Adapter.viewholder> {
    ...
    public EmailCoach_Adapter(List<Result> results, Activity activity,boolean fromCoachside) {
    ...
    @Override
    public EmailCoach_Adapter.viewholder onCreateViewHolder(ViewGroup parent, int viewType) {

        final View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.coach_select, parent, false);

        EmailCoach_Adapter.viewholder holder = new EmailCoach_Adapter.viewholder(itemView);
        itemView.setTag(holder);
        itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EmailCoach_Adapter.viewholder holder = (viewholder) v.getTag();
    ...
    @Override
    public void onBindViewHolder(EmailCoach_Adapter.viewholder holder, final int position) {
